...
See it in action at [computationalthinking.mit.edu](https://computationalthinking.mit.edu/)! Sliders, buttons and camera inputs work _instantly_, without having to wait for a Julia process. 

[![](https://data.jsdelivr.com/v1/package/gh/fonsp/Pluto.jl/badge)](https://www.jsdelivr.com/package/gh/fonsp/Pluto.jl) [![documentation](https://img.shields.io/badge/docs-stable-blue.svg)](https://plutojl.org/en/docs/plutosliderserverapi/)
